 ...
 * Questions 'Si j'étais...' avec justifications personnalisées
 */
...
class Module11Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module11_data', JSON.stringify(this.moduleData));
            setSCORMData('module11_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module11_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module11_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module11_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/12';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module11_completed', 'true');
