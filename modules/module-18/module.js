 ...
 * Sélection et justification des 5 motivations principales
 */
...
class Module18Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module18_data', JSON.stringify(this.moduleData));
            setSCORMData('module18_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module18_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module18_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module18_data');
            if (localData) {
