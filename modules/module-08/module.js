 ...
 * Atelier créatif - Sélection de 5 figures archétypiques + expression créative
 */
...
class Module8Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module8_data', JSON.stringify(this.moduleData));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module8_data');
            if (scormData) {
