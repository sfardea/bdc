 ...
 * Auto-évaluation complète des savoirs, savoir-faire et savoir-être
 */
...
class Module14Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module14_data', JSON.stringify(this.moduleData));
            setSCORMData('module14_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module14_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module14_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module14_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/15';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module14_completed', 'true');
