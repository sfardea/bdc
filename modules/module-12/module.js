 ...
 * Formulaire dynamique d'expériences et formations détaillées
 */
...
class Module12Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module12_data', JSON.stringify(this.moduleData));
            setSCORMData('module12_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module12_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module12_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module12_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/13';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module12_completed', 'true');
