 ...
 * Drag-and-drop de 20 facteurs de motivation par priorité
 */
...
class Module13Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module13_data', JSON.stringify(this.moduleData));
            setSCORMData('module13_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module13_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module13_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module13_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/14';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module13_completed', 'true');
