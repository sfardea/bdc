 ...
 * Guide structuré pour enquêtes terrain et analyse marché
 */
...
class Module21Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module21_data', JSON.stringify(this.moduleData));
            setSCORMData('module21_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module21_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module21_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module21_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/22';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module21_completed', 'true');
