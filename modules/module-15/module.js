...
class Module15Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module15_data', JSON.stringify(this.moduleData));
            setSCORMData('module15_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module15_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module15_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module15_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/16';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module15_completed', 'true');
