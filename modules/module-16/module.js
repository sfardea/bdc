 ...
 * Test de Holland - Code RIASEC et domaines professionnels
 */
...
class Module16Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module16_data', JSON.stringify(this.moduleData));
            setSCORMData('module16_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module16_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module16_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module16_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/17';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module16_completed', 'true');
