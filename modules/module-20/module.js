/**
 * Module 20 - Exploration orientation
 * Recherches guidées avec prise de notes intégrée
 */
...
class Module20Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module20_data', JSON.stringify(this.moduleData));
            setSCORMData('module20_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module20_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module20_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module20_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/21';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module20_completed', 'true');
