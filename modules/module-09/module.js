 ...
 * Atelier créatif - Exploration des désirs profonds et aspirations
 */
...
class Module9Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module9_data', JSON.stringify(this.moduleData));
            setSCORMData('module9_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module9_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module9_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module9_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/10';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module9_completed', 'true');
