 ...
 * Brainstorming et création de cartes de pistes professionnelles
 */
...
class Module19Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module19_data', JSON.stringify(this.moduleData));
            setSCORMData('module19_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module19_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module19_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module19_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/20';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module19_completed', 'true');
