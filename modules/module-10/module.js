 ...
 * Création d'un cocktail métaphorique avec ingrédients personnalisés
 */
...
class Module10Class {
    ...
    validateAndSubmit() {
        ...
        if (typeof setSCORMData !== 'undefined') {
            setSCORMData('module10_data', JSON.stringify(this.moduleData));
            setSCORMData('module10_completed', 'true');
            setSCORMComplete();
        }
    ...
    saveData() {
        ...
        localStorage.setItem('module10_data', JSON.stringify(data));
    ...
    loadSavedData() {
        ...
        if (typeof getSCORMData !== 'undefined') {
            const scormData = getSCORMData('module10_data');
            if (scormData) {
        ...
        if (!savedData) {
            const localData = localStorage.getItem('module10_data');
            if (localData) {
...
function goToNextModule() {
    window.location.href = '/module/11';
}
...
function showSuccessMessage() {
    ...
    localStorage.setItem('module10_completed', 'true');
